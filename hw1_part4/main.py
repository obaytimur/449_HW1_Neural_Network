...
#        torch.save(model, f'entire_{model_name}_running{run_num}')
    ...
    torch.save(Arch_Dict, f'Results_of_the_Architecture_{model_name}_{opt_name}')
...
train(model2_cuda, optimizer2_1, criterion, train_generator, validation_generator, test_generator, 20, device,
      model_2_name, '1')
train(model2_cuda, optimizer2_01, criterion, train_generator, validation_generator, test_generator, 20, device,
      model_2_name, '01')
train(model2_cuda, optimizer2_001, criterion, train_generator, validation_generator, test_generator, 20, device,
      model_2_name, '001')
