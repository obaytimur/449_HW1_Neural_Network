...
def train(model, optimizer1, optimizer2, optimizer3, loss_criterion, train_dataloader, validation_dataloader, test_dataloader, epochs,
    ...
    for run_num in range(1):
        ...
        for epoch_index in range(epochs):
            ...
            for images, labels in train_dataloader:
                ...
                elif 599 < step_counter & step_counter < 900:
...
#        torch.save(model, f'entire_{model_name}_running{run_num}')
    ...
    plt.title("Learning Rate: 0.1 then 0.01 then 0.001")
...
train(model2_cuda, optimizer2_1, optimizer2_01, optimizer2_001, criterion, train_generator, validation_generator, test_generator, 15, device,
      model_2_name, '1')
